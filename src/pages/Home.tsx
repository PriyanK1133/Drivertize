  ...
  const features = [
    {
      ...
      description:
        "Reach thousands of customers across targeted locations with professional mobile billboards",
    },
    {
      icon: <BarChart3 className="h-8 w-8 text-green-600" />,
      title: "Cost-Effective Solution",
      description:
        "Up to 80% lower cost-per-impression compared to traditional billboards and outdoor advertising",
    },
    {
      icon: <Clock className="h-8 w-8 text-purple-600" />,
      title: "Flexible Duration",
      description:
        "Customizable campaigns from 1-3 months with flexible pricing and professional installation",
    },
    {
      icon: <MapPin className="h-8 w-8 text-yellow-600" />,
      title: "Targeted Reach",
      description:
        "Perfect for local businesses targeting specific neighborhoods and high-traffic areas",
    },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                  ...
                  <span className="text-blue-600"> Ahmedabad</span> with
                  Drivertize
                </h1>
                <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
                  Dominate the streets with Gujarat's most powerful mobile
                  advertising network. Our professional car wrap campaigns
                  deliver unmatched brand visibility and customer engagement
            ...
            <div className="relative flex justify-center">
              ...
              <div className="relative">
                <img
                  src="./drivertize.png" // replace with correct path, e.g. `/public/drivertize-car.png`
                  alt="Drivertize Car"
                  className="w-[480px] h-[480px] rounded-xl shadow-2xl border border-gray-300"
                />
                ...
                {/* Mobile Billboard */}
                <div className="absolute -bottom-10 -right-8 bg-white rounded-xl p-4 shadow-xl border border-gray-200">
                  <div className="flex items-center space-x-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Professional mobile billboard solutions that deliver measurable
              results
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Experience the power of mobile advertising that follows your
                customers everywhere they go. Our strategic network ensures your
                brand dominates the streets during peak business hours and
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Our experts analyze your target market and design compelling
                mobile billboard campaigns for maximum impact
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Premium vinyl installation across our extensive vehicle network
                covering all major routes and business districts
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Watch your brand dominate the streets while tracking Transparent
                reporting to measure visibility
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-gray-600 mb-6">
              Manage and track your advertising campaigns with our comprehensive
              dashboard
            </p>
            {/* Demo Warning */}
              ...
              <div className="flex">
                <div className="ml-3">
                  <p className="text-sm text-yellow-700">
                    <strong>Demo Dashboard:</strong> This is a demonstration
                    dashboard. Some functionality may not function as they would
                    in the live system.
                  </p>
                </div>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-lg">
            ...
            <div className="bg-gray-50 p-1 m-4 sm:m-6 rounded-lg">
              <div className="grid grid-cols-2 sm:flex sm:space-x-1 gap-1 sm:gap-0">
                {["overview", "campaigns", "analytics", "vehicles"].map(
                  (tab) => (
                    <button
                      key={tab}
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join leading brands already capturing massive market share with our
